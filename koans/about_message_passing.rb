...
class AboutMessagePassing < Neo::Koan
  ...
  def test_classes_can_be_asked_if_they_know_how_to_respond
    ...
    assert_equal = mc.respond_to?(:caught?)
    assert_equal = mc.respond_to?(:does_not_exist)
  end
  ...
  def test_sending_a_message_with_arguments
    ...
    assert_equal = mc.add_a_payload(3, 4, nil, 6)
    assert_equal = mc.send(:add_a_payload, 3, 4, nil, 6)
  end
  ...
  def test_all_messages_are_caught
    ...
    assert_equal = catcher.foobar
    assert_equal = catcher.foobaz(1)
    assert_equal = catcher.sum(1,2,3,4,5,6)
  end
  ...
  def test_catching_messages_makes_respond_to_lie
    ...
    assert_equal = catcher.respond_to?(:any_method)
  end
  ...
  def test_foo_method_are_caught
    ...
    assert_equal = catcher.foo_bar
    assert_equal = catcher.foo_baz
  end
  ...
  def test_explicitly_implementing_respond_to_lets_objects_tell_the_truth
    ...
    assert_equal = catcher.respond_to?(:foo_bar)
    assert_equal = catcher.respond_to?(:something_else)
  end
