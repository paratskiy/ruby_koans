...
class AboutToStr < Neo::Koan
  ...
  def test_to_s_returns_a_string_representation
    ...
    assert_equal = not_like_a_string.to_s
  end
  ...
  def test_to_str_also_returns_a_string_representation
    ...
    assert_equal = like_a_string.to_str
  end

  def test_to_str_allows_objects_to_be_treated_as_strings
    assert_equal = File.exist?(CanBeTreatedAsString.new)
  end
  ...
  def test_user_defined_code_can_check_for_to_str
    assert_equal = acts_like_a_string?(CanNotBeTreatedAsString.new)
    assert_equal = acts_like_a_string?(CanBeTreatedAsString.new)
  end
end
